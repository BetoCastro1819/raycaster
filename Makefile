...
raycaster: raylib
ifneq (,$(raycaster_config))
	@echo "==== Building raycaster ($(raycaster_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f raycaster.make config=$(raycaster_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f raycaster.make clean
